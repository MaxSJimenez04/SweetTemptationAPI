...
INSERT INTO Usuario(usuario, contrasena, nombre, apellidos, correo, direccion, telefono, fechaRegistro, idRol) VALUES('STA_MaxSoto', '$2a$10$KV4MW5NgJsnfsO3XATiwcOewp6mmLnSA1njrKoFCAxsm9xmwZVnLG', 'Maximiliano', 'Soto Jim�nez', 'maximiliano.soto.j@gmail.com', 'Av. Independencia #22, Colonia Insurgentes, Ciudad de M�xico', '+522284246249', GETDATE(), 1);
INSERT INTO Usuario(usuario, contrasena, nombre, apellidos, correo, direccion, telefono, fechaRegistro, idRol) VALUES('STE_LuisPerez', '$2a$10$dm0NsBysOYfAzd9u29JlTOIgjCuzIvXAlajndc3HmnNQJFBpBTpfC', 'Luis', 'P�rez Gonz�lez','luis.perez@gmail.com', 'Calle Norte 2 #12, Colonia Centro, Puebla, Puebla', '+522225614821', GETDATE(), 2);
INSERT INTO Usuario(usuario, contrasena, nombre, apellidos, correo, direccion, telefono, fechaRegistro, idRol) VALUES('TeresaSuarez1989', '$2a$10$5PiWX2.SVzVWvBk9b8pBwOgJ9rbhDMDvTrqD9NkuLBfzWVCJCVAVG', 'Teresa', '�lvarez Su�rez', 'ts1989@gmail.com','Calle Hollywood #12-B Colonia Europa, Ensenada, Baja California', '+526332154981', GETDATE(), 3);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Pastel Tres Leches', 'Pastel cl�sico de tres leches con crema batida y fresas frescas', 122.00, 1, 10, GETDATE(), 1);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Pastel Red Velvet', 'Pan rojo aterciopelado con bet�n de queso crema', 270.00, 1, 8, GETDATE(), 1);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Pastel de Zanahoria', 'Pan h�medo con nuez y glaseado de queso crema', 240.50, 1, 6, GETDATE(), 1);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Pastel Vainilla Frutas', 'Pastel de vainilla con relleno de durazno y pi�a', 230.00, 1, 10, GETDATE(), 1);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Cupcake de Vainilla', 'Cupcake de vainilla con bet�n de mantequilla', 20.00, 1, 28, GETDATE(), 2);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Cupcake Red Velvet', 'Cupcake con bet�n de queso crema', 32.00, 1, 25, GETDATE(), 2);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Galleta Integral', 'Galleta de avena sin az�car a�adida', 10.00, 1, 22, GETDATE(), 3);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Tarta de Lim�n', 'Tarta con crema de lim�n y merengue', 57.50, 1, 6, GETDATE(), 4);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Dona Rellena de Cajeta', 'Dona rellena de cajeta con az�car glas', 31.50, 1, 20, GETDATE(), 5);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Brownie Cl�sico', 'Brownie tradicional con textura h�meda y sabor intenso a cacao', 29.00, 1, 20, GETDATE(), 6);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Mousse de Mango', 'Postre fr�o con pur� natural de mango', 155.50, 1, 8, GETDATE(), 7);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Pay de Lim�n', 'Postre fr�o con galleta y crema de lim�n', 115.00, 1, 6, GETDATE(), 8);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Mini Pay de Queso', 'Peque�os pays de queso con mermelada', 94.00, 1, 9, GETDATE(), 8);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Flan Napolitano', 'Flan casero con caramelo l�quido', 72.00, 1, 8, GETDATE(), 9);
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Chocoflan', 'Combinaci�n de pastel de chocolate y flan', 77.00, 1, 6, GETDATE(), 9);
...
INSERT INTO Producto(nombre, descripcion, precio, disponible, unidades, fechaRegistro, categoria) VALUES('Churros', 'Porci�n de 4 churros con az�car y canela', 15.00, 1, 20, GETDATE(), 10);
...
INSERT INTO PedidoPersonalizado(idPedido, cobertura, especificaciones, relleno, saborBizcocho, tamano, fechaCompra, fechaSolicitud) VALUES(7, 'Chocolate', 'Frase "Feliz cumplea�os"', 'Durazno', 'Vainilla', '2 pisos', 2025-11-15, GETDATE());
